...
namespace SqlSearcher
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class SqlExplorerCommand
    {
        /// <summary>
        /// Command ID.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SqlExplorerCommand"/> class.
        /// Adds our command handlers for menu (commands must exist in the command table file)
        /// </summary>
        /// <param name="package">Owner package, not null.</param>
        private SqlExplorerCommand(Package package)
        {
            if (package == null)
        ...
        /// </summary>
        public static SqlExplorerCommand Instance { get; private set; }
